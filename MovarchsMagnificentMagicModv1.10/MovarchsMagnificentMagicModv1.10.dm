#modname "Morvarch's Magnificent Magic Mod v1.10"
...
-- TODO: Missing spell ID, uncomment when we have this ID
--#newspell
...
-- TODO: Missing ID, add back in splash effect once we have that ID
#newspell
